...
public class TransmissionInfo{
	 ...
	 * @param controlInformation If (transmissionType != TransmissionType.Silent), sets the control information that
	 *                              should be sent on the medium in the next timeslot
	 */
