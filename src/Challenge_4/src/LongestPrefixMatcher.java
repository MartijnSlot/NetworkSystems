...
class LongestPrefixMatcher {
	...
	public static final String ACCESS_TOKEN = "s0063533_3kzpw";

	public static final String ROUTES_FILE  = "routes.txt";
	public static final String LOOKUP_FILE  = "lookup.txt";

    public Map<Integer, Integer[]> routes = new HashMap<Integer, Integer[]>();
	...
	private void addRoute(int ip, byte prefixLength, int portNumber) {
        ...
        routes.put(shiftedIP, prefixPort);
	}
    ...
    private int getPrefix(int shiftedLookupIP) {
        return routes.get(shiftedLookupIP)[0];
    }
